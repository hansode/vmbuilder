...
function _test_create_vm_no_options() {
  create_vm ${disk_filename} ${chroot_dir}
  assertEquals $? 0
}

function test_create_vm_xpart_multiple_partitions_root_swap_opt_home_usr_var_tmp() {
...
function _test_create_vm_xpart_multiple_partitions_xpart() {
